...
async function main() {
  ...
  await prisma.user.upsert({
    ...
    create: {
      ...
      email,
      passwordHash,
      bio: "Photographer based in Gdansk, Poland.",
  ...
  await prisma.work.createMany({
    data: [
      ...
      { title: "Self-Reflection", categoryId: 2, order: 1, date: "August 2025", banner: "https://res.cloudinary.com/dt0qtsury/image/upload/v1767026207/3foto_1_l3ow6b.jpg", description: "I don't know what I want to say here yet. It won’t be long though "},
    ],
    skipDuplicates: true,
  });
